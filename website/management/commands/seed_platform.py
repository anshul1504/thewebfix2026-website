...
from website.models import BlogPost, Brochure, CareerOpening, Client, ContentPage, FounderProfile, Product, Project, Service, SiteSettings, SocialLink, Testimonial
...
"privacy":("Legal","Privacy Policy","How The Webfix collects, uses and protects personal information."),
"terms":("Legal","Terms of Use","The terms governing use of The Webfix website and published materials."),
"refund":("Legal","Refund Policy","How refunds are considered for professional services and digital products."),
...
class Command(BaseCommand):
    def handle(self,*args,**options):
        ...
        SocialLink.objects.update_or_create(platform="WhatsApp", defaults={"url":"https://wa.me/919993098691","order":3,"is_active":True})
        SocialLink.objects.exclude(platform__in=["Instagram","LinkedIn","WhatsApp"]).update(is_active=False)
        products = [
